...
# Optimizers
ScaledAdam = argbind.bind(dac.optim.ScaledAdam)
Eden2 = argbind.bind(dac.optim.Eden2)
...
def load(
    ...
    with argbind.scope(args):
        optimizer = ScaledAdam(model.flow_matching.named_parameters())
        scheduler = Eden2(optimizer)
